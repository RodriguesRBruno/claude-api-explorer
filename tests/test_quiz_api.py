...
class TestGetWithRetry:
    ...
    @mock.patch("utils.quiz_api.httpx.get")
    ...
    @mock.patch("utils.quiz_api.time.sleep")
    @mock.patch("utils.quiz_api.httpx.get")
...
class TestListTopics:
    ...
    @mock.patch("utils.quiz_api._get")
...
class TestExecuteTool:
    ...
    def test_list_topics_dispatch(self):
        ...
        with mock.patch("utils.quiz_api.list_topics") as mock_func:
    ...
    def test_list_quizzes_dispatch(self):
        ...
        with mock.patch("utils.quiz_api.list_quizzes") as mock_func:
            mock_func.return_value = {"status": "ok", "data": []}
            result = execute_tool(
    ...
    def test_get_quiz_dispatch(self):
        ...
        with mock.patch("utils.quiz_api.get_quiz") as mock_func:
            mock_func.return_value = {"status": "ok", "data": {}}
